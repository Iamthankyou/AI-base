...
public class TrieuPhu_KeCuop_Practice_Solution_BestFirstSearch {
    public class Node{
...
//            }
    ...
    public static void main(String args[]){
        TrieuPhu_KeCuop_Practice_Solution_BestFirstSearch solve = new TrieuPhu_KeCuop_Practice_Solution_BestFirstSearch();
        solve.bfs();
    }
